...
#-------- configure pip to use code artifact -------#
echo "Set pip index to Code Artifact..."
...
echo "export CODEARTIFACT_AUTH_TOKEN=$CODEARTIFACT_AUTH_TOKEN" >> /home/ec2-user/.zshrc

touch /etc/pip.conf
echo "[global]" >> /etc/pip.conf
echo "index-url=https://aws:$CODEARTIFACT_AUTH_TOKEN@stellaralgo-176624903806.d.codeartifact.us-east-1.amazonaws.com/pypi/machine-learning/simple/" >> /etc/pip.conf
